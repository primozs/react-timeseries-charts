...
var Styler = exports.Styler = function () {
        ...
        if (_underscore2.default.isArray(columns)) {
            columns.forEach(function (column) {
                if (_underscore2.default.isString(column)) {
                    ...
                    var key = column.key,
                        _style = _objectWithoutProperties(column, ["key"]);
    ...
    _createClass(Styler, [{
        ...
        value: function barChartStyle() {
            var style = {};
            _underscore2.default.forEach(this._columnStyles, function (_ref3, column) {
        ...
        value: function scatterChartStyle() {
            var style = {};
            _underscore2.default.forEach(this._columnStyles, function (_ref4, column) {
