    ...
    _createClass(RangeBar, [{
        ...
        value: function render() {
            var _props2 = this.props,
                ...
                bgstyle = _props2.bgstyle,
                fgstyle = _props2.fgstyle,
                scale = _props2.scale,
                size = _props2.size;
...
exports.default = _react2.default.createClass({
    ...
    renderRows: function renderRows(seriesList) {
        ...
        var _props5 = this.props,
            ...
            spacing = _props5.spacing,
            padding = _props5.padding,
            size = _props5.size,
            style = _props5.style,
            format = _props5.format,
            display = _props5.display,
            timestamp = _props5.timestamp,
            onSelectionChanged = _props5.onSelectionChanged,
            selectionColor = _props5.selectionColor,
            onNavigate = _props5.onNavigate,
            navigateColor = _props5.navigateColor;
