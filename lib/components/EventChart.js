...
exports.default = _react2.default.createClass({
    ...
    propTypes: {
         ...
         */
        hoverMarkerWidth: _react2.default.PropTypes.number,

        /**
         * Hover text offset position X
         */
        textOffsetX: _react2.default.PropTypes.number,

        /**
         * Hover text offset position Y
         */
        textOffsetY: _react2.default.PropTypes.number,
         ...
         */
        label: _react2.default.PropTypes.oneOfType([_react2.default.PropTypes.string, _react2.default.PropTypes.func])
    },

    /**
     * Continues a hover event on a specific bar of the bar chart.
     */
    onMouseOver: function onMouseOver(e, event) {
                ...
                if (isHover) {
                    text = _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            "text",
                            {
                                style: _extends({ pointerEvents: "none", fill: "#444" }, eventLabelStyle),
                ...
                eventMarkers.push(_react2.default.createElement(
                    ...
                    _react2.default.createElement("rect", {
                        ...
                        onMouseOver: function onMouseOver(e) {
                            return _this.onMouseOver(e, event);
                        } }),
                    text
                ));
            };
